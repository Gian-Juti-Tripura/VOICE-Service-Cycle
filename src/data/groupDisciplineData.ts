...
export const INITIAL_DISCIPLINE_STUDENTS: StudentDisciplineRecord[] = [
  ...
  { id: 'member_5', name: 'DIPEN P.', group: 'VOICE', phone: '01571422381', cycleOrder: 6, monthlyStrikes: 3, status: 'DEMOTION_DUE' },
  { id: 'member_6', name: 'ANKON P.', group: 'VOICE', phone: '01933503979', cycleOrder: 7, monthlyStrikes: 4, status: 'DEMOTION_DUE' },
  { id: 'member_7', name: 'ANTOR P.', group: 'VOICE', phone: '+880 1704-370139', cycleOrder: 8, monthlyStrikes: 4, status: 'DEMOTION_DUE' },
  { id: 'member_8', name: 'ROTON P.', group: 'VOICE', phone: '+880 1750-504601', cycleOrder: 9, monthlyStrikes: 3, status: 'DEMOTION_DUE' },
  { id: 'member_9', name: 'JOY S. P.', group: 'VOICE', phone: '+880 1734-550288', cycleOrder: 10, monthlyStrikes: 3, status: 'DEMOTION_DUE' },
  { id: 'member_10', name: 'JOYKANT P.', group: 'VOICE', phone: '+880 1754-034183', cycleOrder: 11, monthlyStrikes: 2, status: 'WARNED' },
  { id: 'member_11', name: 'BAPPI C. P.', group: 'VOICE', cycleOrder: 12, monthlyStrikes: 2, status: 'WARNED' },
  { id: 'member_3', name: 'PRANTO P.', group: 'LOTUS', phone: '+880 1609-302008', cycleOrder: 4, monthlyStrikes: 3, status: 'DEMOTION_DUE' },
  { id: 'member_4', name: 'SANGA P.', group: 'LOTUS', phone: '+880 1722-711849', cycleOrder: 5, monthlyStrikes: 9, status: 'DISMISSED' },
];
